...
int prev_button_reading; // stores the last button reading value
...
void loop() 
{
  ...
  if (prev_button_reading == 1 && current_button_reading==0)
  {
    request_new_color();
  }
  prev_button_reading = current_button_reading;
...
{  
     system("python /media/realroot/cheerlights_sender_random_solution.py");
}
